    ...
    <div className="dashboard-layout">
      ...
      <aside className="sidebar">
        <div className="sidebar-header">
          ...
          <span className="logo-text" onClick={handleBackToHome} style={{ cursor: 'pointer' }}>BlogForge AI</span>
        </div>

        <div style={{ padding: '0 12px' }}>
          <button
            onClick={handleBackToHome}
            style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px', color: '#64748B', cursor: 'pointer', padding: '8px 12px', borderRadius: '8px', marginBottom: '8px', transition: 'all 0.2s', border: 'none', background: 'transparent', width: '100%', textAlign: 'left' }}
